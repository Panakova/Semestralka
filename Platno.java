...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("Padajúce kvapky", 350, 500, 
                                         Color.white);
        }
    ...
    /**
     * Zobrazí rámik s informáciou o aktuálnom skóre.
     */
    public void setRamik (String retazec) {
        this.graphic.drawString(retazec, 20, 20);
    }
